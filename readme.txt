...
Tags: ecommerce, woocommerce, recent sales notification, popup, live sales feed
...
This plugin is built to seamlessly connect your WooCommerce website to our <a href="https://beeketing.com/sales-pop?utm_channel=applisting&utm_medium=woolisting&utm_fromapp=spop" target="_blank">Sales Pop</a> app on Beeketing platform. All features are configured and managed in our server, so the plugin is most lightweight as possible and takes minimum resources from your website.
...
<a href="http://sales-pop.demo.beeketing.com/" target="_blank">sales-pop-demo.beeketing.com</a>
...
Refer to our [Terms of Service](https://beeketing.com/terms-of-service) and [Privacy Policy](https://beeketing.com/privacy-policy) for more information.
...
Find more information here: <a href="https://beeketing.freshdesk.com/support/solutions/articles/24000022887-why-should-i-migrate-from-sales-pop-plugin-to-beeketing-plugin-" target="_blank">Why should I migrate from Sales Pop to Beeketing plugin</a>
...
1. Simple black theme on desktop and mobile view
2. Rounded black theme on desktop and mobile view
3. Rounded white theme on desktop and mobile view
4. List of notifications on home dashboard
5. Display options to manage how and when notifications show
6. Design message and theme of notifications to match with your store's theme
...
== Changelog ==
= 1.4.18 - 19/12/2019 =
* Improve - Compatibility Wordpress 5.3

= 1.4.16 - 20/06/2019 =
* Fix - Warning messages Product API

= 1.4.15 - 07/06/2019 =
* Update - Replace old apis

= 1.4.14 - 21/05/2019 =
* Improve - Reduce cookies size

= 1.4.13 - 20/05/2019 =
* Fix - Ignore zero price variants
* Improve - API performance

= 1.4.10,1.4.11 - 17/05/2019 =
* Fix - Get wrong atrribute name
* Improve - Compatibility Wordpress 5.2
...
= 1.4.5 - 24/12/2018 =
* Fix - Sales Pop notification timestamp

= 1.4.4 - 18/12/2018 =
* Fix - Can not sync currency format in UTF-8 special character

= 1.4.3 - 13/12/2018 =
* Add - Popup to notify customer when their server block Beeketing requests
* Add - Integrate with featured-image-from-url plugin
* Improve - Data sync

= 1.4.2 - 23/11/2018 =
* Fix - 500 error when can not call webhook
* Fix - Clean unused files
* Improve - Compatibility PHP 7.3
...
* Add - Sync product variant images
* Improve - Compatibility Wordpress 5.0
* Improve - Compatibility PHP 7.3

= 1.3.2 - 26/10/2018 =
* Fix - Fix error when install app
* Fix - Acquire better UX

= 1.3.1 - 11/10/2018 =
* Fix - Support more product types
* Fix - Support currency settings of woocommerce
